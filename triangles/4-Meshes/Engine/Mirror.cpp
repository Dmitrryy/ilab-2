...
namespace ezg
{
                              ...
                              , const RenderMaterial& last) const
    {
        ...
        const PushConstants pushConst1 = {
                .viewProjMatrix = camera.getProjectionMatrix() * camera.getViewMatrix(),
                                              ...
                                              , const std::vector< Renderable* >& objects)
    {
        ...
        for (size_t k = 0, mk = m_cubeFrameBuffers.size(); k < mk; ++k) {
            ...
            switch (k) {
                case 0: // POSITIVE_X
                    viewMatrix = glm::lookAt(getPosition()
                                             , getPosition() + glm::vec3(1.f, 0.f, 0.f)
                ...
                case 2:    // POSITIVE_Y
                    viewMatrix = glm::lookAt(getPosition()
                                             , getPosition() + glm::vec3(0.f, 1.f, 0.f)
                ...
                case 4:    // POSITIVE_Z
                    viewMatrix = glm::lookAt(getPosition()
                                             , getPosition() + glm::vec3(0.f, 0.f, 1.f)
                                             , glm::vec3(0.f, -1.f, 0.f));
                    break;
                case 5:    // NEGATIVE_Z
                    viewMatrix = glm::lookAt(getPosition()
